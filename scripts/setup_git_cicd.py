...
def setup_git():
    ...
    print("\n" + "=" * 65)
    print("  [OK] Repositorio Git Local e Estructura de Ramas Configurados:")
    print("  - Rama Actual de Trabajo: dev")
    print("  - Rama de Produccion: main")
    print("=" * 65)
    print("\n[INFO] PASOS FINALES PARA SUBIR A TU REPOSITORIO EN GITHUB:")
    ...
    print("\n[INFO] Los Workflows de GitHub Actions en .github/workflows/ci-cd.yml ejecutaran el pipeline automaticamente.")
    print("=" * 65)
